...
(function ($) {
    ...
    $.fn.extend({
        ...
        outerHTML: function(value){
            /// <summary>
            ///     Returns the outerHTML for the first element matched, replaces the all elements matched by another
            ///     returning the element in the chain, or allow value as Function to let the developer to decide
            ///     what to do with every element in the object.
            /// </summary>
            /// <param name="value">
            ///     A HTML String, Element or Function.
            /// </param>
            /// <returns>
            ///     Either a HTML String or the jQuery instance.
            /// </returns>
